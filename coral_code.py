...
def main():
  ...
  for name in files:
    ...
    interpreter = make_interpreter('/home/mendel/IA_coral_code/efficientdet-lite1-flo_3.tflite')
    ...
    if (type(nb_personne) == int):
      ...
      cur = conn.cursor()
      cur.execute("INSERT INTO stats (nom_element, nb_element, precision , nom_fichier) VALUES (%s, %s, %s,%s)",(nomelement,nb_personne, mydate ,name))
      conn.commit()
      cur.close()
      conn.close()
    ...
    if (type(nb_motorcycle) == int):
      ...
      cur = conn.cursor()
      print("connexion OK")
      cur.execute("INSERT INTO stats (nom_element, nb_element, precision , nom_fichier) VALUES (%s, %s, %s,%s)",(nomelement,nb_motorcycle, mydate ,name))
      conn.commit()
      cur.close()
      conn.close()
    ...
    if (type(nb_truck) == int):
      ...
      print("connexion OK")
      cur = conn.cursor()
      cur.execute("INSERT INTO stats (nom_element, nb_element, precision , nom_fichier) VALUES (%s, %s, %s,%s)",(nomelement,nb_truck, mydate ,name))
      conn.commit()
      cur.close()
      conn.close()
